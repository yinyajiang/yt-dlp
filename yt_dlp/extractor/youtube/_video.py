...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    def _extract_formats_and_subtitles(self, video_id, player_responses, player_url, live_status, duration, out_additional_info=None):
        CHUNK_SIZE = 10 << 20
        ...
        for pr in player_responses:
            ...
            def process_format_stream(fmt_stream, proto, missing_pot, super_resolution=False):
                ...
                dct = {
                    ...
                    '_is_damaged': is_damaged and format_duration and duration,
    ...
    def _list_formats(self, video_id, microformats, video_details, player_responses, player_url, duration=None, out_additional_info=None):
        ...
        *formats, subtitles = self._extract_formats_and_subtitles(video_id, player_responses, player_url, live_status, duration, out_additional_info=out_additional_info)
    ...
    def _real_extract_with_additional_info(self, url, in_out_additional_info=None):
        ...
        webpage, webpage_ytcfg, initial_data, is_premium_subscriber, player_responses, player_url = self._initial_extract(
            url, smuggled_data, webpage_url, self._webpage_client, video_id, in_out_additional_info)
